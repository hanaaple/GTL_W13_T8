...
FLuaScriptManager FEngineLoop::ScriptSys;
...
int32 FEngineLoop::Init(HINSTANCE hInstance)
{
    ...
    FSoundManager::GetInstance().LoadSound("Scream", "Contents/Sounds/Scream.mp3");
    FSoundManager::GetInstance().LoadSound("BGM", "Contents/Sounds/BGM.mp3", true);
